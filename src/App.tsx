...
const predefinedLayouts: ScreenLayout[] = [
  {
    id: 'layout-01',
    blocks: [
      { id: 'headline', kind: 'headline', x: 1, y: 1, w: 7, h: 2, z: 1},
      { id: 'next', kind: 'button_next', x: 9, y: 1, w: 4, h: 1, z: 2 },
      { id: 'users', kind: 'users_left_panel', x: 8, y: 2, w: 5, h: 3, z: 1},
      { id: 'input', kind: 'input_panel', x: 1, y: 3, w: 7, h: 3, z: 1},
      { id: 'stack', kind: 'trashed_pages_stack', x: 8, y: 5, w: 2, h: 1, z: 2},
  ...
  },
  {
    id: 'layout-02',
    blocks: [
      { id: 'users', kind: 'users_left_panel', x: 1, y: 1, w: 6, h: 3, z: 1},
      { id: 'input', kind: 'input_panel', x: 7, y: 1, w: 6, h: 2, z: 1},
      { id: 'headline', kind: 'headline', x: 1, y: 4, w: 7, h: 2, z: 1},
      { id: 'timer', kind: 'timer_panel', x: 8, y: 4, w: 5, h: 2, z: 1 },
      { id: 'stack', kind: 'trashed_pages_stack', x: 9, y: 6, w: 2, h: 1, z: 2},
  ...
  },
  {
    ...
    blocks: [
      { id: 'users', kind: 'users_left_panel', x: 1, y: 1, w: 6, h: 3, z: 1},
      { id: 'input', kind: 'input_panel', x: 7, y: 1, w: 6, h: 3, z: 1},
      { id: 'next', kind: 'button_next', x: 1, y: 4, w: 6, h: 1, z: 2 },
      { id: 'stack', kind: 'trashed_pages_stack', x: 7, y: 4, w: 2, h: 1, z: 2},
      { id: 'trash', kind: 'button_trash', x: 9, y: 4, w: 3, h: 1, z: 3 },
      { id: 'headline', kind: 'headline', x: 1, y: 5, w: 7, h: 2, z: 1},
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: 'headline', kind: 'headline', x: 6, y: 1, w: 7, h: 2, z: 1},
      { id: 'trash', kind: 'button_trash', x: 1, y: 3, w: 2, h: 1, z: 3 },
      { id: 'stack', kind: 'trashed_pages_stack', x: 5, y: 3, w: 2, h: 1, z: 2},
      { id: 'next', kind: 'button_next', x: 7, y: 3, w: 4, h: 1, z: 2 },
      { id: 'users', kind: 'users_left_panel', x: 1, y: 4, w: 6, h: 3, z: 1},
      { id: 'input', kind: 'input_panel', x: 7, y: 4, w: 6, h: 3, z: 1},
    ],
  },
  {
    id: 'layout-05',
    blocks: [
      { id: 'headline', kind: 'headline', x: 1, y: 1, w: 7, h: 2, z: 1},
      { id: 'next', kind: 'button_next', x: 9, y: 1, w: 4, h: 1, z: 2 },
      { id: 'users', kind: 'users_left_panel', x: 9, y: 2, w: 4, h: 2, z: 1},
      { id: 'trash', kind: 'button_trash', x: 1, y: 3, w: 2, h: 1, z: 3 },
      { id: 'stack', kind: 'trashed_pages_stack', x: 3, y: 3, w: 2, h: 1, z: 2},
      { id: 'timer', kind: 'timer_panel', x: 1, y: 4, w: 4, h: 3, z: 1 },
      { id: 'input', kind: 'input_panel', x: 5, y: 4, w: 8, h: 3, z: 1},
    ],
  },
  {
    id: 'layout-06',
    blocks: [
      ...
      { id: 'stack', kind: 'trashed_pages_stack', x: 3, y: 1, w: 2, h: 1, z: 2},
      { id: 'headline', kind: 'headline', x: 1, y: 2, w: 7, h: 3, z: 1},
      { id: 'users', kind: 'users_left_panel', x: 8, y: 1, w: 5, h: 3, z: 1},
      { id: 'input', kind: 'input_panel', x: 8, y: 4, w: 5, h: 2, z: 1},
  ...
  },
  {
    ...
    blocks: [
      { id: 'headline', kind: 'headline', x: 1, y: 1, w: 7, h: 2, z: 1},
      { id: 'users', kind: 'users_left_panel', x: 9, y: 1, w: 4, h: 3, z: 1},
      { id: 'input', kind: 'input_panel', x: 1, y: 3, w: 8, h: 3, z: 1},
      { id: 'stack', kind: 'trashed_pages_stack', x: 9, y: 4, w: 2, h: 1, z: 2},
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: 'users', kind: 'users_left_panel', x: 1, y: 2, w: 5, h: 3, z: 1},
      { id: 'timer', kind: 'timer_panel', x: 1, y: 5, w: 3, h: 2, z: 1 },
      { id: 'trash', kind: 'button_trash', x: 4, y: 5, w: 2, h: 1, z: 3 },
      { id: 'stack', kind: 'trashed_pages_stack', x: 4, y: 6, w: 2, h: 1, z: 2},
      { id: 'input', kind: 'input_panel', x: 6, y: 1, w: 4, h: 6, z: 1},
      { id: 'headline', kind: 'headline', x: 10, y: 1, w: 3, h: 5, z: 1},
    ],
  },
]
